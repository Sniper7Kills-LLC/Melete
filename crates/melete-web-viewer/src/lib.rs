//! `journal-web-viewer` — read-only canvas viewer for the Melete web POC.
//!
...
//! The desktop's full brush engine in `melete_canvas::vello_renderer` uses
...
// ---------------------------------------------------------------------
// Background-config helper duplicated from `melete_templates::canvas_bridge`
