...
use journal_core::{BackgroundType, NotebookKind, PageTemplate, Stroke, TemplateId, TilingMode, TemplateWidget, Viewport};
...
/// `BackgroundType` is the main divergence from `journal_core::PageTemplate`'s
