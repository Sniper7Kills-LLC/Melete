...
use melete_canvas::background_renderer::BackgroundConfig;
...
fn cursor_shape_description(c: &melete_core::CursorShape) -> &'static str {
...
fn cursor_idx(c: &melete_core::CursorShape) -> u32 {
    use melete_core::CursorShape as CS;
    match c {
        CS::Auto => 0,
        CS::Circle => 1,
...
fn default_cursor_for(idx: u32) -> melete_core::CursorShape {
    use melete_core::CursorShape as CS;
    match idx {
        1 => CS::Circle,
...
fn fill_cursor_subparams(
    parent: &GtkBox,
    cursor: melete_core::CursorShape,
    editor_state: Rc<RefCell<EditorState>>,
    rebuild: Rc<RefCell<Option<Rc<dyn Fn()>>>>,
) {
    use melete_core::CursorShape as CS;
...
fn build_layer_settings(
    ...
    let presets = melete_core::brush::nib_presets();
