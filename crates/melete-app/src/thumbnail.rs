...
use gtk4::cairo;
use melete_canvas::{paint_with_widgets, BackgroundConfig, ViewportTransform};
use melete_core::{PageId, PageTemplate, Rect, Stroke, TemplateWidget, Viewport};
// StrokeStore methods reached via dyn NotebookBackend.
