...
use melete_canvas::{hit_test_handle, selection_combined_bbox};
use melete_core::{Rect, Stroke, StrokePoint};
// StrokeStore methods are reached via the dyn NotebookBackend in state — no import needed.
use uuid::Uuid;
