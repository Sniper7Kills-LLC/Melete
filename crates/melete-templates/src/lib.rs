...
pub fn is_builtin(id: melete_core::TemplateId) -> bool {
    matches!(
        id.0,
        BUILTIN_BLANK_ID
            | BUILTIN_DOTTED_ID
...
mod tests {
    use super::*;
    use melete_core::BackgroundType;
...
"#,
    ...
    fn canvas_bridge_maps_variants() {
        use melete_canvas::BackgroundConfig;
    ...
    fn canvas_bridge_maps_image() {
        use melete_canvas::BackgroundConfig;
        use melete_core::{PageTemplate, TemplateId, TilingMode};
        use uuid::Uuid;
        let t = PageTemplate {
            id: TemplateId(Uuid::new_v4()),
            name: "Img".into(),
