// Custom AppSync JS resolver for `publishNotebookTemplate`. Same shape
// as publish-page-template.js but for the NotebookTemplate model
// (no asset re-copy; notebook templates have no binary assets).
